    ...
    <div className="min-h-screen px-6 pb-[92px] animate-fade-up">
        ...
        <div className="mt-2 flex items-center gap-4 rounded-[18px] border border-line bg-white p-[18px]">
          ...
          <div className="min-w-0 flex-1">
            ...
            />
            <p className="text-[12.5px] text-muted">Tap name or photo to edit</p>
          </div>
        </div>
        ...
        <p className="mb-2.5 mt-[26px] text-xs font-semibold uppercase tracking-[.1em] text-muted">Your products</p>
        ...
        <p className="mb-2.5 mt-[26px] text-xs font-semibold uppercase tracking-[.1em] text-muted">Account</p>
        <button
