...
const en = {
  ...
  "landing.heroSubtitle":
    "Create a payment link in seconds. Your buyer pays however they like — the status flips to Lunas ✓ the moment it's done.",
  ...
  "profile.subtitle":
    "A name and photo make your checkout feel personal. Takes ten seconds — you can change it anytime.",
  ...
  "checkout.copyHint": "On this phone? Copy the address and paste it into your payment app.",
  ...
  "checkout.addressCopied": "Payment address copied",
...
const id: Record<Key, string> = {
  ...
  "landing.heroSubtitle":
    "Buat tautan pembayaran dalam hitungan detik. Pembeli bayar sesuka mereka — status berubah jadi Lunas ✓ begitu selesai.",
  ...
  "checkout.copyHint": "Buka di HP ini? Salin alamat dan tempel ke aplikasi pembayaran Anda.",
  ...
  "checkout.addressCopied": "Alamat pembayaran tersalin",
